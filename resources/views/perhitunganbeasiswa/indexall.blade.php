...
<section class="content card" style="padding: 10px 10px 20px 20px">
    <div class="box">
        ...
        <div class="row">
            <div class="col">
                <h4><i class="nav-icon fas fa-layer-group my-0 btn-sm-1"></i> Laporan BPKM</h4>
                <hr>
            </div>
        </div>

        <!-- Filter Tahun Masuk, Tahun Pelajaran, and Jenis Beasiswa -->
        <form method="GET" action="{{ route('perhitunganbeasiswaall') }}">
            <div class="row">
                <div class="col-md-3">
        ...
        @if(request('tahun_masuk') || request('tahun_pelajaran') || request('jenis_beasiswa') || request('aprove'))
            ...
            @endif
                . 
                <a href="{{ route('perhitunganbeasiswaall') }}" class="btn btn-sm btn-warning">Reset</a>
            </div>
        @endif
        <div class="col">
