...
<section class="content card" style="padding: 10px 10px 20px 20px">
    <div class="box">
        ...
        <div class="row">
            <div class="col">
                <h4><i class="nav-icon fas fa-layer-group my-0 btn-sm-1"></i> Approve Beasiswa</h4>
                <hr>
            </div>
        </div>
        ...
        @if(request('tahun_masuk') || request('tahun_pelajaran') || request('jenis_beasiswa')|| request('aprove'))
            ...
            @endif
                ...
                . 
                <a href="{{ route('approve') }}" class="btn btn-sm btn-warning">Reset</a>
            </div>
        @endif
        <div class="col text-right">
            <a class="btn btn-primary btn-sm my-1 mr-sm-1 " href="/approve/export_excel" role="button">
                ...
                <table class="table table-hover table-head-fixed" id="tabelAgendaMasuk">
                    <thead>
                        <tr class="bg-light">
                            ...
                            <th><div style="width:70px;">Tahun Angkatan</div></th>
                            <th><div style="width:70px;">Tahun Pelajaran</div></th>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('approve.update', $siswas->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <button type="submit" class="btn btn-success btn-sm" style="width: 100px;">Approve</button>
                                </form>
                                @else
                                <form action="{{ route('approve.update', $siswas->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <button type="submit" class="btn  btn-danger btn-sm" style="width: 100px;">Batalkan Approve</button>
                                </form>
                                @endif
                            </td>
